...
from Head_detections import Head_detection
from Physical_detections import Physical_detection
from Squint_detections import Squint_detection
from Head_forwards import Head_forward
import sqlite3
import emails as em
# import pymysql
...
class PoseDetector():
    ...
    def findpose(self, img, draw=True):
        ...
        if self.results.pose_landmarks:  # 如果采集到图像
            print("pose_landmarks", self.results.pose_landmarks)
            if draw:
...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def show_camera(self):
        ...
        cv2.putText(self.image, "Body tilt left", (30, 175), cv2.FONT_HERSHEY_PLAIN, 2, (255, 255, 255), 2)
        cv2.putText(self.image, "Body tilt right", (30, 200), cv2.FONT_HERSHEY_PLAIN, 2, (255, 255, 255), 2)
